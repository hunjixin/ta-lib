...
pub const SarExt = @import("sar.zig").SarExt;
...
pub const LinearReg = @import("linearreg").LinearReg;
pub const LinearRegAngle = @import("linearregangle").LinearRegAngle;
pub const LinearRegIntercept = @import("linearregintercept").LinearRegIntercept;
pub const LinearRegSlope = @import("linearregslope").LinearRegSlope;
pub const AvgPrice = @import("avgprice").AvgPrice;
pub const MedPrice = @import("medprice").MedPrice;
pub const TypPrice = @import("typprice").TypPrice;
pub const WclPrice = @import("wclprice").WclPrice;
pub const Tsf = @import("tsf").Tsf;
...
pub const Sum = @import("mult.zig").Sum;
